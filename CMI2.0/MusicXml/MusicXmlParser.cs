...
namespace MusicXml
{
	public static class MusicXmlParser
	{
		...
		public static Backup GetBackupElement(XmlNode node)
		{
		...
		public static Note GetNote(XmlNode noteNode)
		{
			var note = new Note();
		...
		public static Pitch GetPitch(XmlNode noteNode)
		{
			var pitch = new Pitch();
		...
		public static Lyric GetLyric(XmlNode noteNode)
		{
			var lyric = new Lyric();
		...
		public static Clef GetClef(XmlNode attributesNode)
		{
			var clef = new Clef();
		...
		public static Time GetTime(XmlNode attributesNode)
		{
			var time = new Time();
		...
		public static Identification GetIdentification(XmlNode document)
		{
		...
		public static Encoding GetEncoding(XmlNode identificationNode)
		{
		...
		public static string GetInnerTextOfChildTag(XmlNode encodingNode, string tagName)
		{
